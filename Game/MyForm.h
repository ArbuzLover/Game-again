...
/*class Hero {
	...
	int dmg;
public:
	Hero(std::string _name, int _hp, int _dmg)
	{
		name = _name;
		hp = _hp;
		dmg = _dmg;
	}
	const std::string& nameGet() const { return name; }
};

//std::string nameGet() {};
Hero Pudge("Pudge", 100, 20);
Hero Putin("Putin", 100, 20);
Hero Walter("Walter", 100, 25);
Hero Geralt("Geralt", 150, 30);*/
int heroIndex;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(730, 213);
			...
			this->button2->Location = System::Drawing::Point(718, 288);
			...
			this->button3->Location = System::Drawing::Point(730, 362);
